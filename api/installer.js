...
class Installer extends Api {
  ...
  accept_(id, manifestState) {
    ...
    // removed all alert pop-ups, some might be useful for unsupported API's
    ...
    //open extension page (might be necessary in future)
  ...
  download_(id) {
    ...
    return new Promise((resolve, reject) => {
         ...
         // This is a hack, we should find a better way to fix issue with downloading
         // multiple extensions at same session (somehow to refresh or using tabs.create())
         setTimeout(function(){chrome.tabs.reload()}, 1500);
		 resolve();
